...
class ScanChooser(HIGVBox):
    ...
    def _create_widgets(self):
        ...
        self.btn_open_scan = Gtk.Button.new_from_stock("打开")
        self.exp_scan = Gtk.Expander.new(_("扫描输出"))
...
class DiffWindow(Gtk.Window):
    def __init__(self, scans):
        ...
        self.btn_close = HIGButton("关闭")
        self.hbox_selection = HIGHBox()
        self.scan_chooser_a = ScanChooser(scans, _("A 扫描"))
        self.scan_chooser_b = ScanChooser(scans, _("B 扫描"))
