...
class NodeNotebook(Gtk.Notebook):
    ...
    def __create_widgets(self):
        ...
        self.append_page(self.__system_page, BWLabel(_('常规')))
        self.append_page(self.__services_page, BWLabel(_('服务')))
        self.append_page(self.__trace_page, BWLabel(_('路由跟踪')))
...
class ServicesPage(Gtk.Notebook):
    ...
    def __create_widgets(self):
        ...
        self.__ports_label = BWLabel(_('端口 (%s)') % number_of_ports)
        ...
        xports_label_text = _('出口 (%s)') % number_of_xports
        ...
        self.append_page(self.__viewer, BWLabel(_('特殊域')))
...
class SystemPage(BWScrolledWindow):
    ...
    def __create_widgets(self):
        ...
        self.__general_frame = BWExpander(_('一般信息'))
        self.__sequences_frame = BWExpander(_('序列'))
        self.__os_frame = BWExpander(_('操作系统'))
        ...
        self.__address_label = BWSectionLabel(_('地址:'))
        ...
        if self.__node.get_info('hostnames') is not None:
            ...
            self.__hostname_label = BWSectionLabel(_('主机名:'))
        ...
        if os is not None:
            ...
            self.__fp_label = BWSectionLabel(_('使用的端口:'))
    ...
    def __create_sequences_widget(self, sequences):
        ...
        if tcp is not None:
            ...
            tcp_note.set_markup(
                TCP_SEQ_NOTE % {'index': tcp['index'], 'difficulty': tcp['difficulty']})
