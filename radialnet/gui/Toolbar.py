...
class ToolsMenu(Gtk.Menu):
    ...
    def __create_items(self):
        """
        """
        self.__hosts = Gtk.ImageMenuItem.new_with_label(_('主机查看'))
