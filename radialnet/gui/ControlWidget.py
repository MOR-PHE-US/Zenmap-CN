...
class ControlInterpolation(BWExpander):
    ...
    def __create_widgets(self):
        ...
        self.__frames_label = Gtk.Label.new(_('帧'))
...
class ControlLayout(BWExpander):
    ...
    def __create_widgets(self):
        ...
        self.__layout.append_text(_('对称'))
        self.__layout.append_text(_('权重'))
...
class ControlRingGap(BWVBox):
    ...
    def __create_widgets(self):
        ...
        self.__label = Gtk.Label.new(_('内层环间距'))
