...
class HostOpenPorts(HIGVBox):
    ...
    def _create_widgets(self):
        ...
        self.port_columns['hostname'] = Gtk.TreeViewColumn(title=_('主机'))
        self.port_columns['icon'] = Gtk.TreeViewColumn(title='')
        self.port_columns['port_number'] = Gtk.TreeViewColumn(title=_('端口'))
        self.port_columns['protocol'] = Gtk.TreeViewColumn(title=_('协议'))
        self.port_columns['state'] = Gtk.TreeViewColumn(title=_('状态'))
        self.port_columns['service'] = Gtk.TreeViewColumn(title=_('服务'))
        self.port_columns['version'] = Gtk.TreeViewColumn(title=_('版本'))
        ...
        self.host_columns['service'] = Gtk.TreeViewColumn(title=_('服务'))
        self.host_columns['icon'] = Gtk.TreeViewColumn(title='')
        self.host_columns['hostname'] = Gtk.TreeViewColumn(title=_('主机名'))
        self.host_columns['protocol'] = Gtk.TreeViewColumn(title=_('协议'))
        self.host_columns['port_number'] = Gtk.TreeViewColumn(title=_('端口'))
        self.host_columns['state'] = Gtk.TreeViewColumn(title=_('状态'))
        self.host_columns['version'] = Gtk.TreeViewColumn(title=_('版本'))
