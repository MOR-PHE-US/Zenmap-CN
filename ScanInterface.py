...
class ScanResult(Gtk.Paned):
    ...
    def __init__(self, inventory, scans_store, scan_interface=None):
        ...
        self.filter_toggle_button = Gtk.ToggleButton.new_with_label(_("过滤主机"))
...
class ScanResultNotebook(HIGNotebook):
    ...
    def __init__(self, inventory, scans_store):
        ...
        self.append_page(self.nmap_output_page, Gtk.Label.new(_('Nmap 输出')))
        self.append_page(self.open_ports_page, Gtk.Label.new(_('端口 / 主机')))
        self.append_page(self.topology_page, Gtk.Label.new(_('拓扑')))
        self.append_page(self.host_details_page, Gtk.Label.new(_('主机详情')))
        self.append_page(self.scans_list_page, Gtk.Label.new(_('扫描记录')))
