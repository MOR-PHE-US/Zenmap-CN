...
class ScanToolbar(HIGHBox):
    ...
    def __init__(self):
        ...
        self.scan_button = Gtk.Button.new_with_label(_("扫描"))
        self.cancel_button = Gtk.Button.new_with_label(_("取消"))
    ...
    def _create_target(self):
        ...
        self.target_label = HIGEntryLabel(_("目标:"))
    ...
    def _create_profile(self):
        ...
        self.profile_label = HIGEntryLabel(_('配置文件:'))
