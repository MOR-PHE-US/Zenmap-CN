...
class ScanHostsView(HIGVBox):
    ...
    def _create_widgets(self):
        # Mode buttons
        self.host_mode_button = Gtk.ToggleButton.new_with_label(_("主机"))
        self.service_mode_button = Gtk.ToggleButton.new_with_label(_("服务"))
        ...
        self.pic_column = Gtk.TreeViewColumn(title=_('系统'))
        self.host_column = Gtk.TreeViewColumn(title=_('主机'))
        ...
        self.service_column = Gtk.TreeViewColumn(title=_('服务'))
